          ...
          <div class="hidden sm:ms-6 sm:flex sm:items-center">
            ...
            <div class="relative">
              ...
              <div v-show="showNav" class="absolute right-0 z-50 mt-2 w-48 rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5">
                ...
                <Link v-if="page?.props?.authkit?.hasApiTokens" href="/user/api-tokens" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">API Tokens</Link>
