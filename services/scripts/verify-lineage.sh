...
patterns=(
  "V1|namespace leak|Illuminate"
  "V2|upstream pkg path|laravel/(framework|boost|ai|docs)"
  "V3|brand mention|\bLaravel\b"
  ...
  "V7|doc marker|(upstream|laravel)-docs:"
...
v9_hits=$(find . \
  ...
  -type f \( -iname '*laravel*' -o -iname '*illuminate*' \) -print 2>/dev/null || true)
if [ -n "$v9_hits" ]; then
