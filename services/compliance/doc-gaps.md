<!--
  Generated derivative report. Source of truth for status:
    ...
    services/compliance/docs-inventories/upstream-docs.txt
...
A prioritized view of every Upstream 13.x documentation section that is **not yet
...
`services/scripts/upstream-compliance.sh` summary uses; it adds per-section
...
| Upstream    | `upstream/docs@13.x` pinned at `bfe893709` (`services/compliance/sources.lock.json`) |
| Inventory   | `services/compliance/docs-inventories/upstream-docs.txt` — 875 sections              |
...
The 200 pending sections are spread across **56 Upstream doc files**, every one
...
| **P2 — Specialized**  | Optional products and ecosystem packages: Billing/billing, OAuthServer, SocialAuth, AuthFlows, JobQueue, DebugBar, FeatureFlags, HTTPPreview, Prompts, WebSockets, Search, Concurrency, RemoteTasks, Boost/AI SDK/MCP.                                                                              |

## P0 — Foundational (18 files, 60 sections)

| Upstream doc         | Bedrock target                                | Pending | Notes                                                                                                                          |
| ------------------- | --------------------------------------------- | ------: | ------------------------------------------------------------------------------------------------------------------------------ |
...
| `orm.md`       | `services/docs/packages/database.md`          |       1 | Getting-started slug for the ORM-equivalent surface.                                                                           |
...
| Upstream doc        | Bedrock target                            | Pending | Notes                                                                                                                                                                              |
| ------------------ | ----------------------------------------- | ------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `cli.md`       | `services/docs/packages/console.md`       |       1 | `writing-commands` slug.                                                                                                                                                           |
...
| `logging.md`       | `services/docs/packages/log.md`           |       5 | Page-level slug, configuration, building log stacks, writing log messages, tailing via `logtail`.                                                                                     |
...
| `ai.md`           | `services/docs/packages/ai/boost.md`     |       1 | `upstream-boost` page-level slug.                                                   |
| `billing.md`      | `services/docs/packages/billing.md`        |       4 | Page-level slug, customers, subscriptions, checkout.                               |
...
| `remotetasks.md`        | `services/docs/packages/remotetasks.md`        |       3 | Page-level slug, writing tasks, running tasks.                                     |
| `authflows.md`      | `services/docs/packages/authflows.md`      |       2 | Page-level slug, two-factor authentication.                                        |
| `jobqueue.md`      | `services/docs/packages/jobqueue.md`      |       5 | Page-level slug, running, tags, metrics, notifications.                            |
| `mcp.md`          | `services/docs/packages/ai/mcp.md`       |       4 | Page-level slug, creating servers, tools, resources.                               |
| `oauthserver.md`     | `services/docs/packages/oauthserver.md`     |       4 | Page-level slug, authorization-code grant, client-credentials grant, token scopes. |
| `featureflags.md`      | `services/docs/packages/featureflags.md`      |       3 | Page-level slug, defining features, checking features.                             |
| `httppreview.md` | `services/docs/packages/httppreview.md` |       3 | Page-level slug, live validation, testing.                                         |
...
| `websockets.md`       | `services/docs/packages/websockets.md`       |       3 | Page-level slug, running the server, events.                                       |
| `search.md`        | `services/docs/packages/search.md`        |       3 | Page-level slug, searching, custom engines.                                        |
| `socialauth.md`    | `services/docs/packages/socialauth.md`    |       3 | Page-level slug, authentication, retrieving user details.                          |
| `debugbar.md`    | `services/docs/packages/debugbar.md`    |       4 | Page-level slug, available watchers, filtering, tagging.                           |
...
2. **Write or expand** the target Bedrock page identified above. Standard
   ...
   relevant section: `<!-- upstream-docs: <file>.md#<slug> -->`.
...
4. **Regenerate** `services/compliance/report.md` via the existing pipeline
   (`services/scripts/upstream-compliance.sh`); the
...
with open('services/compliance/docs-inventories/upstream-docs.txt') as f:
...
in `services/scripts/upstream-compliance.sh:621`. The priority bucketing in the
...
under `excluded:` in `services/compliance/docs-status.yml`. They cover Template,
...
- `ai-sdk.md#events`
- `ai-sdk.md#upstream-ai-sdk`
- `ai-sdk.md#testing`

### `ai.md` — 1 pending

- `ai.md#upstream-boost`

### `cli.md` — 1 pending

- `cli.md#writing-commands`
...
- `billing.md#upstream-cashier-stripe`
- `billing.md#subscriptions`

### `boost.md` — 3 pending

- `boost.md#agent-skills`
- `boost.md#upstream-boost`
- `boost.md#mcp-server`
...
### `remotetasks.md` — 3 pending

- `remotetasks.md#upstream-remotetasks`
- `remotetasks.md#running-tasks`
- `remotetasks.md#writing-tasks`
...
### `authflows.md` — 2 pending

- `authflows.md#upstream-authflows`
- `authflows.md#two-factor-authentication`
...
### `jobqueue.md` — 5 pending

- `jobqueue.md#upstream-jobqueue`
- `jobqueue.md#metrics`
- `jobqueue.md#notifications`
- `jobqueue.md#running-jobqueue`
- `jobqueue.md#tags`
...
- `logging.md#logging`
- `logging.md#tailing-log-messages-using-logtail`
...
### `oauthserver.md` — 4 pending

- `oauthserver.md#authorization-code-grant`
- `oauthserver.md#client-credentials-grant`
- `oauthserver.md#upstream-oauthserver`
- `oauthserver.md#token-scopes`

### `featureflags.md` — 3 pending

- `featureflags.md#checking-features`
- `featureflags.md#defining-features`
- `featureflags.md#upstream-featureflags`

### `httppreview.md` — 3 pending

- `httppreview.md#live-validation`
- `httppreview.md#httppreview`
- `httppreview.md#testing`
...
### `websockets.md` — 3 pending

- `websockets.md#events`
- `websockets.md#upstream-websockets`
- `websockets.md#running-the-server`
...
- `search.md#custom-engines`
- `search.md#upstream-search`
- `search.md#searching`
...
### `socialauth.md` — 3 pending

- `socialauth.md#authentication`
- `socialauth.md#upstream-socialauth`
- `socialauth.md#retrieving-user-details`
...
### `debugbar.md` — 4 pending

- `debugbar.md#available-watchers`
- `debugbar.md#filtering`
- `debugbar.md#upstream-debugbar`
- `debugbar.md#tagging`
