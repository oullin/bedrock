...
Generated: 2026-04-22T06:26:17Z
...
| --------------------- | -----------: | ------: | ----------------- | ----------------------------------------------------------------------------------------- |
| Tests                 | 4458 / 13066 |    8608 | Not compliant     | Port executable equivalents or add divergence overrides for Go adaptations.               |
...
| Overall               | 4937 / 14052 |    9115 | Not compliant     | Start with the Critical Path below; close the largest missing surfaces first.             |
...
|    8 | `Illuminate\Http` -> `httpx`             |     488 |    0 / 488 | Not compliant | Port executable equivalents or add divergence overrides for Go adaptations.               |
|    9 | `Illuminate\Testing`                     |     381 |    0 / 381 | Not compliant | Implement the surface or convert it to a permanent exclusion.                             |
|   10 | `Illuminate\Routing` -> `routing`        |     315 |    0 / 315 | Not compliant | Port executable equivalents or add divergence overrides for Go adaptations.               |
|   11 | `laravel/prompts` -> `prompts`           |     310 |    3 / 313 | Not compliant | Port executable equivalents or add divergence overrides for Go adaptations.               |
|   12 | `laravel/scout` -> `scout`               |     252 |    0 / 252 | Not compliant | Port executable equivalents or add divergence overrides for Go adaptations.               |
|   13 | `laravel/reverb` -> `reverb`             |     232 |    0 / 232 | Not compliant | Port executable equivalents or add divergence overrides for Go adaptations.               |
|   14 | `laravel/passport` -> `passport`         |     211 |    0 / 211 | Not compliant | Port executable equivalents or add divergence overrides for Go adaptations.               |
|   15 | `laravel/pennant` -> `pennant`           |     186 |    0 / 186 | Not compliant | Port executable equivalents or add divergence overrides for Go adaptations.               |
...
| --------------------- | ----------: | -------------: | -----------: | ----------------------: | ------------: |
| All inventories       |          51 |          13066 | 1314 (10.1%) |            8608 (65.9%) |  3144 (24.1%) |
| Framework inventories |          34 |           9009 | 1311 (14.6%) |            4554 (50.5%) |  3144 (34.9%) |
