...
Generated: 2026-04-21T08:47:44Z
...
| inventories/framework-config.txt          | Tracking file for upstream tests, not a compliant path | `laravel/framework@13.x:tests/Config`                  |     0 / 33 |            33 | Not compliant     | Port executable equivalents or add divergence overrides for Go adaptations. |
| inventories/framework-console.txt         | Tracking file for upstream tests, not a compliant path | `laravel/framework@13.x:tests/Console`                 |    0 / 156 |           156 | Not compliant     | Implement the surface or convert it to a permanent exclusion.               |
| inventories/framework-container.txt       | Tracking file for upstream tests, not a compliant path | `laravel/framework@13.x:tests/Container`               |    0 / 193 |           193 | Not compliant     | Port executable equivalents or add divergence overrides for Go adaptations. |
...
| inventories/framework-queue.txt           | Tracking file for upstream tests, not a compliant path | `laravel/framework@13.x:tests/Queue`                   |  161 / 204 |            43 | Not compliant     | Port executable equivalents or add divergence overrides for Go adaptations. |
