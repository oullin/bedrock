...
Generated: 2026-04-21T08:40:35Z
...
|    8 | Laravel documentation                    |     508 |  367 / 875 | Not compliant | Port relevant sections, adapt Go-specific sections, or exclude product-boundary sections. |
...
|   12 | `Illuminate\Cache` -> `cache`            |     313 |    0 / 313 | Not compliant | Port executable equivalents or add divergence overrides for Go adaptations.               |
|   13 | `laravel/prompts` -> `prompts`           |     310 |    3 / 313 | Not compliant | Port executable equivalents or add divergence overrides for Go adaptations.               |
|   14 | `laravel/scout` -> `scout`               |     252 |    0 / 252 | Not compliant | Port executable equivalents or add divergence overrides for Go adaptations.               |
|   15 | `laravel/reverb` -> `reverb`             |     232 |    0 / 232 | Not compliant | Port executable equivalents or add divergence overrides for Go adaptations.               |

## Counting Rules

- Upstream tests: non-comment entries in generated inventory files.
- Ported tests: Go Laravel test markers found in `*_laravel_test.go`.
- Adapted tests: entries in `services/compliance/divergences.yml`.
- Missing tests: upstream entries not yet ported or adapted.

## Inventories

| Inventory                                 | Source                                                 | Counting Rule                                | Upstream Tests | Ported Tests | Missing Tests | Adapted Tests |
| ----------------------------------------- | ------------------------------------------------------ | -------------------------------------------- | -------------: | -----------: | ------------: | ------------: |
| inventories/framework-auth.txt            | `laravel/framework@13.x:tests/Auth`                    | upstream entries -> Go markers / divergences |            257 |   54 (21.0%) |      0 (0.0%) |   203 (79.0%) |
| inventories/framework-broadcasting.txt    | `laravel/framework@13.x:tests/Broadcasting`            | upstream entries -> Go markers / divergences |             55 |  55 (100.0%) |      0 (0.0%) |      0 (0.0%) |
| inventories/framework-bus.txt             | `laravel/framework@13.x:tests/Bus`                     | upstream entries -> Go markers / divergences |             66 |     0 (0.0%) |   66 (100.0%) |      0 (0.0%) |
| inventories/framework-cache.txt           | `laravel/framework@13.x:tests/Cache`                   | upstream entries -> Go markers / divergences |            313 |     0 (0.0%) |  313 (100.0%) |      0 (0.0%) |
| inventories/framework-concurrency.txt     | `laravel/framework@13.x:tests/Integration/Concurrency` | upstream entries -> Go markers / divergences |             12 |     0 (0.0%) |   12 (100.0%) |      0 (0.0%) |
| inventories/framework-conditionable.txt   | `laravel/framework@13.x:tests/Conditionable`           | upstream entries -> Go markers / divergences |              2 |     0 (0.0%) |    2 (100.0%) |      0 (0.0%) |
| inventories/framework-config.txt          | `laravel/framework@13.x:tests/Config`                  | upstream entries -> Go markers / divergences |             33 |     0 (0.0%) |   33 (100.0%) |      0 (0.0%) |
| inventories/framework-console.txt         | `laravel/framework@13.x:tests/Console`                 | upstream entries -> Go markers / divergences |            156 |     0 (0.0%) |  156 (100.0%) |      0 (0.0%) |
| inventories/framework-container.txt       | `laravel/framework@13.x:tests/Container`               | upstream entries -> Go markers / divergences |            193 |     0 (0.0%) |  193 (100.0%) |      0 (0.0%) |
| inventories/framework-cookie.txt          | `laravel/framework@13.x:tests/Cookie`                  | upstream entries -> Go markers / divergences |             26 |     0 (0.0%) |   26 (100.0%) |      0 (0.0%) |
| inventories/framework-database.txt        | `laravel/framework@13.x:tests/Database`                | upstream entries -> Go markers / divergences |           2626 |     0 (0.0%) | 2626 (100.0%) |      0 (0.0%) |
| inventories/framework-encryption.txt      | `laravel/framework@13.x:tests/Encryption`              | upstream entries -> Go markers / divergences |             27 |     0 (0.0%) |   27 (100.0%) |      0 (0.0%) |
| inventories/framework-events.txt          | `laravel/framework@13.x:tests/Events`                  | upstream entries -> Go markers / divergences |             76 |     0 (0.0%) |   76 (100.0%) |      0 (0.0%) |
| inventories/framework-filesystem.txt      | `laravel/framework@13.x:tests/Filesystem`              | upstream entries -> Go markers / divergences |            134 |     0 (0.0%) |  134 (100.0%) |      0 (0.0%) |
| inventories/framework-hashing.txt         | `laravel/framework@13.x:tests/Hashing`                 | upstream entries -> Go markers / divergences |             13 |     0 (0.0%) |   13 (100.0%) |      0 (0.0%) |
| inventories/framework-http.txt            | `laravel/framework@13.x:tests/Http`                    | upstream entries -> Go markers / divergences |            488 |     0 (0.0%) |  488 (100.0%) |      0 (0.0%) |
| inventories/framework-json-schema.txt     | `laravel/framework@13.x:tests/JsonSchema`              | upstream entries -> Go markers / divergences |             47 |     0 (0.0%) |   47 (100.0%) |      0 (0.0%) |
| inventories/framework-log.txt             | `laravel/framework@13.x:tests/Log`                     | upstream entries -> Go markers / divergences |             98 |     0 (0.0%) |   98 (100.0%) |      0 (0.0%) |
| inventories/framework-mail.txt            | `laravel/framework@13.x:tests/Mail`                    | upstream entries -> Go markers / divergences |            135 |     0 (0.0%) |  135 (100.0%) |      0 (0.0%) |
| inventories/framework-notifications.txt   | `laravel/framework@13.x:tests/Notifications`           | upstream entries -> Go markers / divergences |             71 |     0 (0.0%) |   71 (100.0%) |      0 (0.0%) |
| inventories/framework-pagination.txt      | `laravel/framework@13.x:tests/Pagination`              | upstream entries -> Go markers / divergences |             48 |     0 (0.0%) |   48 (100.0%) |      0 (0.0%) |
| inventories/framework-pipeline.txt        | `laravel/framework@13.x:tests/Pipeline`                | upstream entries -> Go markers / divergences |             22 |     0 (0.0%) |   22 (100.0%) |      0 (0.0%) |
| inventories/framework-process.txt         | `laravel/framework@13.x:tests/Process`                 | upstream entries -> Go markers / divergences |             54 |     0 (0.0%) |   54 (100.0%) |      0 (0.0%) |
| inventories/framework-queue.txt           | `laravel/framework@13.x:tests/Queue`                   | upstream entries -> Go markers / divergences |            204 |  161 (78.9%) |    43 (21.1%) |      0 (0.0%) |
| inventories/framework-redis.txt           | `laravel/framework@13.x:tests/Redis`                   | upstream entries -> Go markers / divergences |            103 |     0 (0.0%) |  103 (100.0%) |      0 (0.0%) |
| inventories/framework-routing.txt         | `laravel/framework@13.x:tests/Routing`                 | upstream entries -> Go markers / divergences |            315 |     0 (0.0%) |  315 (100.0%) |      0 (0.0%) |
| inventories/framework-session.txt         | `laravel/framework@13.x:tests/Session`                 | upstream entries -> Go markers / divergences |             93 |     0 (0.0%) |   93 (100.0%) |      0 (0.0%) |
| inventories/framework-support.txt         | `laravel/framework@13.x:tests/Support`                 | upstream entries -> Go markers / divergences |           1554 |   129 (8.3%) |  1425 (91.7%) |      0 (0.0%) |
| inventories/framework-support-str.txt     | `laravel/framework@13.x:tests/Support`                 | upstream entries -> Go markers / divergences |            115 |   69 (60.0%) |    46 (40.0%) |      0 (0.0%) |
| inventories/framework-support-lottery.txt | `laravel/framework@13.x:tests/Support`                 | upstream entries -> Go markers / divergences |             14 |     0 (0.0%) |   14 (100.0%) |      0 (0.0%) |
| inventories/framework-testing.txt         | `laravel/framework@13.x:tests/Testing`                 | upstream entries -> Go markers / divergences |            381 |     0 (0.0%) |  381 (100.0%) |      0 (0.0%) |
| inventories/framework-translation.txt     | `laravel/framework@13.x:tests/Translation`             | upstream entries -> Go markers / divergences |             52 |    9 (17.3%) |    43 (82.7%) |      0 (0.0%) |
| inventories/framework-validation.txt      | `laravel/framework@13.x:tests/Validation`              | upstream entries -> Go markers / divergences |            597 |    34 (5.7%) |   563 (94.3%) |      0 (0.0%) |
| inventories/framework-collections.txt     | `laravel/framework@13.x:tests/Support`                 | upstream entries -> Go markers / divergences |            629 |    21 (3.3%) |   608 (96.7%) |      0 (0.0%) |
| inventories/package-ai.txt                | `laravel/ai@0.x:tests`                                 | upstream entries -> Go markers / divergences |            774 |     0 (0.0%) |  774 (100.0%) |      0 (0.0%) |
| inventories/package-boost.txt             | `laravel/boost@main:tests`                             | upstream entries -> Go markers / divergences |            671 |     0 (0.0%) |  671 (100.0%) |      0 (0.0%) |
| inventories/package-fortify.txt           | `laravel/fortify@1.x:tests`                            | upstream entries -> Go markers / divergences |             91 |     0 (0.0%) |   91 (100.0%) |      0 (0.0%) |
| inventories/package-jetstream.txt         | `laravel/jetstream@5.x:tests`                          | upstream entries -> Go markers / divergences |             43 |     0 (0.0%) |   43 (100.0%) |      0 (0.0%) |
| inventories/package-mcp.txt               | `laravel/mcp@main:tests`                               | upstream entries -> Go markers / divergences |            624 |     0 (0.0%) |  624 (100.0%) |      0 (0.0%) |
| inventories/package-passport.txt          | `laravel/passport@13.x:tests`                          | upstream entries -> Go markers / divergences |            211 |     0 (0.0%) |  211 (100.0%) |      0 (0.0%) |
| inventories/package-pennant.txt           | `laravel/pennant@1.x:tests`                            | upstream entries -> Go markers / divergences |            186 |     0 (0.0%) |  186 (100.0%) |      0 (0.0%) |
| inventories/package-prompts.txt           | `laravel/prompts@main:tests`                           | upstream entries -> Go markers / divergences |            313 |     3 (1.0%) |   310 (99.0%) |      0 (0.0%) |
| inventories/package-reverb.txt            | `laravel/reverb@main:tests`                            | upstream entries -> Go markers / divergences |            232 |     0 (0.0%) |  232 (100.0%) |      0 (0.0%) |
| inventories/package-scout.txt             | `laravel/scout@11.x:tests`                             | upstream entries -> Go markers / divergences |            252 |     0 (0.0%) |  252 (100.0%) |      0 (0.0%) |
| inventories/package-socialite.txt         | `laravel/socialite@5.x:tests`                          | upstream entries -> Go markers / divergences |             40 |     0 (0.0%) |   40 (100.0%) |      0 (0.0%) |
| inventories/package-spark.txt             | `/Users/gocanto/Sites/madora/tests/Feature/Billing`    | upstream entries -> Go markers / divergences |            166 |     0 (0.0%) |  166 (100.0%) |      0 (0.0%) |
| inventories/package-telescope.txt         | `laravel/telescope@5.x:tests`                          | upstream entries -> Go markers / divergences |            113 |     0 (0.0%) |  113 (100.0%) |      0 (0.0%) |
| inventories/package-horizon.txt           | `laravel/horizon@5.x:tests`                            | upstream entries -> Go markers / divergences |            180 |     0 (0.0%) |  180 (100.0%) |      0 (0.0%) |
| inventories/package-pail.txt              | `laravel/pail@main:tests`                              | upstream entries -> Go markers / divergences |             38 |     0 (0.0%) |   38 (100.0%) |      0 (0.0%) |
| inventories/package-envoy.txt             | `laravel/envoy@2.x:tests`                              | upstream entries -> Go markers / divergences |             20 |     0 (0.0%) |   20 (100.0%) |      0 (0.0%) |
| inventories/package-wayfinder.txt         | `laravel/wayfinder@main:tests`                         | upstream entries -> Go markers / divergences |            103 |     0 (0.0%) |  103 (100.0%) |      0 (0.0%) |
