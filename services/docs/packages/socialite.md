...
| Package     | Purpose                                                                                                          |
| ----------- | ---------------------------------------------------------------------------------------------------------------- |
| `socialite` | Package socialite provides OAuth1 and OAuth2 social authentication, mirroring Laravel\Socialite in idiomatic Go. |
...
Use package tests as executable examples when the exact constructor requires collaborators. The tests under `packages/socialite` cover the supported creation paths, default values, and Laravel parity behavior.
