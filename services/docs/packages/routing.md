...
```bash
GOWORK=/Users/gocanto/Sites/bedrock/storage/.cache/go.work go test -count=1 ./packages/routing/...
```
...
| Package       | Purpose                                                                            |
| ------------- | ---------------------------------------------------------------------------------- |
| `routing`     | Package routing is a 1:1 Go port of upstream/framework 13.x src/Framework/Routing. |
...
Use package tests as executable examples when the exact constructor requires collaborators. The tests under `packages/routing` cover the supported creation paths, default values, and Upstream parity behavior.
