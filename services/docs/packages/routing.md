...
| Package       | Purpose                                                                            |
| ------------- | ---------------------------------------------------------------------------------- |
| `routing`     | Package routing is a 1:1 Go port of laravel/framework 13.x src/Illuminate/Routing. |
...
Use package tests as executable examples when the exact constructor requires collaborators. The tests under `packages/routing` cover the supported creation paths, default values, and Laravel parity behavior.
