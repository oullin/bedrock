...
Package bus provides Upstream-inspired command/job dispatching with support for synchronous dispatch, async queue dispatch, after-response deferred dispatch, job chaining, batch processing, pipeline middleware, and distributed unique-job locking.
...
| Package    | Purpose                                                                                                                                                                                                                                               |
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `bus`      | Package bus provides Upstream-inspired command/job dispatching with support for synchronous dispatch, async queue dispatch, after-response deferred dispatch, job chaining, batch processing, pipeline middleware, and distributed unique-job locking. |
...
Use package tests as executable examples when the exact constructor requires collaborators. The tests under `packages/bus` cover the supported creation paths, default values, and Upstream parity behavior.
