...
The `ai/sdk` package provides a single, expressive interface for multiple AI providers
following the manager + provider + gateway pattern used throughout Bedrock. It
mirrors the Upstream AI package with full functional parity adapted to Go.

**Module:** `github.com/bedrock/packages/ai/sdk`
