...
Package translation provides Upstream-inspired i18n support: key-based message lookup with namespace/fallback resolution, CLDR pluralization, file-based and in-memory loaders, and atomic placeholder substitution.
...
| Package       | Purpose                                                                                                                                                                                                             |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `translation` | Package translation provides Upstream-inspired i18n support: key-based message lookup with namespace/fallback resolution, CLDR pluralization, file-based and in-memory loaders, and atomic placeholder substitution. |
...
Use package tests as executable examples when the exact constructor requires collaborators. The tests under `packages/translation` cover the supported creation paths, default values, and Upstream parity behavior.
