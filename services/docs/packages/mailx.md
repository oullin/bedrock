...
<!-- laravel-docs: mail.md#introduction -->
...
SMTP, log, and array (testing) transports. It mirrors Laravel's Mail
...
Use package tests as executable examples when the exact constructor requires collaborators. The tests under `packages/mailx` cover the supported creation paths, default values, and Laravel parity behavior.
