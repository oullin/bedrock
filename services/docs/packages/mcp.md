...
The `mcp` package provides a complete Go implementation of the MCP server
...
**Module:** `github.com/bedrock/packages/mcp`

```bash
go get github.com/bedrock/packages/mcp@latest
```
