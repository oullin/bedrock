...
Go applications, with 100 % function parity with Laravel Prompts. It
...
Every interactive prompt returns (value, error) and supports validation,
transformation, default values, and non-interactive fallback. Terminal
I/O is fully injectable for testing via [Fake].
