...
| Package   | Purpose                                                                                                                           |
| --------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `process` | Package process provides a small process runner with fakes, assertions, pools, and pipes inspired by Upstream's Process component. |
...
Use package tests as executable examples when the exact constructor requires collaborators. The tests under `packages/process` cover the supported creation paths, default values, and Upstream parity behavior.
