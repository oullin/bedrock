...
<!-- laravel-docs: artisan.md#writing-commands -->
<!-- laravel-docs: scheduling.md#defining-schedules -->
<!-- laravel-docs: prompts.md#unsupported-environments-and-fallbacks -->

Command runtime, console output helpers, signal traps, and scheduling primitives.

## Overview

The `console` package provides a typed Go adaptation of Laravel's console
