...
Package console provides command, output, prompt, signal, mutex, and scheduler primitives for Bedrock applications.
...
| Package   | Purpose                                                                                                             |
| --------- | ------------------------------------------------------------------------------------------------------------------- |
| `console` | Package console provides command, output, prompt, signal, mutex, and scheduler primitives for Bedrock applications. |
