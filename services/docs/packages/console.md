...
<!-- upstream-docs: cli.md#introduction -->
...
| Package   | Purpose                                                                                                                              |
| --------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| `console` | Package console provides Upstream-inspired command, output, prompt, signal, mutex, and scheduler primitives for Bedrock applications. |
...
Use package tests as executable examples when the exact constructor requires collaborators. The tests under `packages/console` cover the supported creation paths, default values, and Upstream parity behavior.
