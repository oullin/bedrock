...
Package inception provides unified authentication scaffolding, team
management, API tokens, and profile management. It ports Laravel
Fortify and Jetstream to Go as a fully standalone module that
...
| Package     | Purpose                                                                                                                                                                                                                              |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `inception` | Package inception provides unified authentication scaffolding, team management, API tokens, and profile management. It ports Laravel Fortify and Jetstream to Go as a fully standalone module that depends only on shared contracts. |
...
Use package tests as executable examples when the exact constructor requires collaborators. The tests under `packages/inception` cover the supported creation paths, default values, and Laravel parity behavior.
