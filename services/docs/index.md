...
home: true
heroText: Bedrock
tagline: A collection of well-tested, Upstream-inspired libraries for building production-grade Go web applications.
actions:
  - text: Get Started
...
features:
  ...
  - title: routing
    details: A faithful 1:1 Go port of Upstream's routing layer. Named routes, resource routing, middleware groups, implicit model binding, and URL generation.
  - title: httpx
  ...
  - title: redis
    details: Full Redis command surface with pipelines, transactions, pub/sub, Lua scripts, cluster and sentinel modes — a 1:1 port of Framework/Redis.
  - title: events
  ...
  - title: encryption
    details: AES encryption with CBC and GCM mode support. Key rotation, MAC verification, and Upstream-compatible payload format.
  - title: hashing
  ...
  - title: pagination
    details: Offset-based and cursor-based pagination with generic item slices. URL windows, JSON serialization, and Upstream-compatible API.
  - title: collection
  ...
  - title: support
    details: Global helpers, Fluent dynamic bags, Optional[T], MessageBag, string builders, Lottery, Sleep, Timebox — a Go port of Framework/Support.
  - title: log
  ...
  - title: inception
    details: Unified authentication scaffolding — Upstream AuthFlows + AuthKit ported. Registration, 2FA, teams, API tokens, profile management with feature flags.
  - title: billing
