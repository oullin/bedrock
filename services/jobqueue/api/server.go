...
// ports JobQueue Vue-facing JSON controllers (BatchesController,
...
// dashboard. JobQueue exposes the same shape via MasterSupervisor::all().
...
// Search ports JobQueue BatchRepository::getRecentUnfinished +
