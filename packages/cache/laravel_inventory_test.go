...
func TestUpstreamArrayStoreInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamFileStoreInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamExternalStoreInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamCacheEventInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamCompositeStoreInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamCacheManagerInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamRateLimiterInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamRepositoryInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamSessionStoreInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamTaggedCacheInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamConcurrencyLimiterInventoryEquivalents(t *testing.T) {
	t.Parallel()
