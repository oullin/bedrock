// Package conditionable provides Upstream-inspired conditional method execution.
...
// functions. A generic Proxy type offers conditional chaining similar to Upstream's
