...
func NewListSessionsHandler(js *Jetstream, sessions SessionRepository) *ListSessionsHandler {
	return &ListSessionsHandler{js: js, sessions: sessions}
}

func (h *ListSessionsHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	if !h.js.features.BrowserSessions {
...
func NewDeleteOtherSessionsHandler(js *Jetstream, sessions SessionRepository) *DeleteOtherSessionsHandler {
	return &DeleteOtherSessionsHandler{js: js, sessions: sessions}
}
