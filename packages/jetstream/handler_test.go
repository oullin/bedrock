...
func buildTestJetstream(user *testTeamUser, teams *testTeamRepo, invitations *testInvitationRepo) (*Jetstream, *testEvents) {
	events := &testEvents{}
...
func TestCreateTeamSuccess(t *testing.T) {
	...
	js, events := buildTestJetstream(user, teams, newTestInvitationRepo())
...
func TestCreateTeamUnauthenticated(t *testing.T) {
	js, _ := buildTestJetstream(nil, newTestTeamRepo(), newTestInvitationRepo())
...
func TestUpdateTeamForbiddenForNonOwner(t *testing.T) {
	...
	teams := newTestTeamRepo(team)
	js, _ := buildTestJetstream(user, teams, newTestInvitationRepo())
...
func TestAcceptInvitationSuccess(t *testing.T) {
	...
	teams := newTestTeamRepo(team)
	invitations := newTestInvitationRepo(invitation)
	js, events := buildTestJetstream(user, teams, invitations)
