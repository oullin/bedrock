...
func NewInviteTeamMemberHandler(js *Jetstream) *InviteTeamMemberHandler {
...
func NewCancelInvitationHandler(js *Jetstream) *CancelInvitationHandler {
...
func NewAcceptInvitationHandler(js *Jetstream) *AcceptInvitationHandler {
