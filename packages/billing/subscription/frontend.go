...
type FrontendStateView struct {
	...
	Plans        []billing.BillingPlan `json:"plans"`
...
func (f *FrontendStateBuilder) Current(ctx context.Context, billableType string, billable billing.Billable) (*FrontendStateView, error) {
...
func (f *FrontendStateBuilder) resolveState(ctx context.Context, billable billing.Billable, sub *billing.Subscription) string {
	if sub == nil {
