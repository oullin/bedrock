...
func (s *orderStoreWithData) FindByID(_ context.Context, _ int64) (*billing.Order, error) {
	return nil, nil
}
func (s *orderStoreWithData) FindByBillable(_ context.Context, _ int64, _ int) ([]billing.Order, error) {
	return s.orders, nil
}
func (s *orderStoreWithData) Create(_ context.Context, _ *billing.Order) error { return nil }
func (s *orderStoreWithData) Save(_ context.Context, _ *billing.Order) error   { return nil }
...
func TestOrderHandler_Index_ReturnsTeamOrders(t *testing.T) {
	...
	store := &orderStoreWithData{
		orders: []billing.Order{
			{ID: 1, TeamID: 1, Status: billing.OrderStatusCompleted},
			{ID: 2, TeamID: 1, Status: billing.OrderStatusPending},
		},
	}
