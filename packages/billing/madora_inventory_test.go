...
type madoraTransactionStore struct {
	...
	billableTransactions []billing.Transaction
...
func TestMadoraFrontendStateInvoiceIDFallsBackToInvoiceNumber(t *testing.T) {
	transactions := &madoraTransactionStore{billableTransactions: []billing.Transaction{
	...
	if invoice["invoice_url"] != "/billing/team/10/invoices/INV-2026-0001/download" {
