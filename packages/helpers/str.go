...
// Delegates to support.StrCamel. Mirrors Laravel's camel_case().
...
// Delegates to support.StrEndsWith. Mirrors Laravel's ends_with().
func EndsWith(subject string, suffixes ...string) bool {
	return support.StrEndsWith(subject, suffixes...)
}

// KebabCase converts a string to kebab-case.
// Delegates to support.StrKebab. Mirrors Laravel's kebab_case().
func KebabCase(value string) string { return support.StrKebab(value) }

// SnakeCase converts a string to snake_case.
// Delegates to support.StrSnake. Mirrors Laravel's snake_case().
...
// Delegates to support.StrStartsWith. Mirrors Laravel's starts_with().
...
// Delegates to support.StrAfter. Mirrors Laravel's str_after().
...
// Delegates to support.StrBefore. Mirrors Laravel's str_before().
...
// Delegates to support.StrContains. Mirrors Laravel's str_contains().
...
// Delegates to support.StrFinish. Mirrors Laravel's str_finish().
...
// Delegates to support.StrPlural. Mirrors Laravel's str_plural().
...
// Delegates to support.StrRandom. Mirrors Laravel's str_random().
...
// Delegates to support.StrReplaceArray. Mirrors Laravel's str_replace_array().
...
// Delegates to support.StrReplaceFirst. Mirrors Laravel's str_replace_first().
...
// Delegates to support.StrReplaceLast. Mirrors Laravel's str_replace_last().
...
// Delegates to support.StrSingular. Mirrors Laravel's str_singular().
func StrSingular(value string) string { return support.StrSingular(value) }

// StrSlug generates a URL-friendly slug.
// Delegates to support.StrSlug. Mirrors Laravel's str_slug().
...
// Delegates to support.StrStart. Mirrors Laravel's str_start().
...
// Delegates to support.StrStudly. Mirrors Laravel's studly_case().
func StudlyCase(value string) string { return support.StrStudly(value) }

// TitleCase converts a string to Title Case.
// Delegates to support.StrTitle. Mirrors Laravel's title_case().
