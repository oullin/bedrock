...
func TestUpstreamEncryptionHappyPathInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamEncryptionAuthenticatedPayloadInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamEncryptionFailureInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamAppearsEncryptedInventoryEquivalents(t *testing.T) {
	t.Parallel()
