...
// IsAttemptingHTTPPreview returns true when the request is precognitive and
// also carries a HTTPPreview-Validate-Only header listing fields to validate.
func (r *Request) IsAttemptingHTTPPreview() bool {
	return r.IsPrecognitive() && r.raw.Header.Get("HTTPPreview-Validate-Only") != ""
}
...
// fields listed in the HTTPPreview-Validate-Only header. If the request is not
