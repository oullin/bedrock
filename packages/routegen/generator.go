...
// Mirrors GenerateCommand::writeMultiRouteControllerMethodExport() + multi-method.template.ts.
...
// It is the Go equivalent of the method.template.ts Template template.
...
// Mirrors function-arguments.template.ts from the PHP implementation.
