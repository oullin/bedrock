// Package support provides Go ports of the upstream Illuminate/Support utilities.
...
//
// This package is a 1:1 Go port of upstream framework 13.x Illuminate/Support.
