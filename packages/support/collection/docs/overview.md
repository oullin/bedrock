...
This Gollin support workspace packages a Go port of [Laravel Collections](https://laravel.com/docs/collections) with fluent, type-safe APIs powered by Go generics and `iter.Seq` lazy evaluation.
