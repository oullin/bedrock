...
This Gollin support workspace packages a Go port of [Upstream Collections](https://upstream.com/docs/collections) with fluent, type-safe APIs powered by Go generics and `iter.Seq` lazy evaluation.
...
```text
github.com/gollin/packages/support/collection
...
```go
import "github.com/gollin/packages/support/collection/collection"
...
```go
import "github.com/gollin/packages/support/collection/collectible"
...
```go
import "github.com/gollin/packages/support/collection/lazy"
