...
func buildTestFortify(guard *testGuard, provider *testProvider, events *testEvents, responder *testResponder) *Fortify {
...
func TestLoginHandlerSuccess(t *testing.T) {
	...
	f := buildTestFortify(guard, provider, events, responder)
...
func TestLoginHandlerJSONInput(t *testing.T) {
	...
	provider := &testProvider{user: user, validPassword: "secret"}
	responder := &testResponder{}
	f := buildTestFortify(guard, provider, &testEvents{}, responder)
