...
func newLaravelRepository() (*config.Repository, map[string]any) {
...
// Ports of Laravel tests/Config/RepositoryTest.php read behavior:
...
func TestLaravelRepositoryReadBehavior(t *testing.T) {
	t.Parallel()

	repo, items := newLaravelRepository()
...
// Ports of Laravel tests/Config/RepositoryTest.php multi-get behavior:
// RepositoryTest::testGetWithArrayOfKeys
// RepositoryTest::testGetMany
func TestLaravelRepositoryGetMany(t *testing.T) {
	t.Parallel()

	repo, _ := newLaravelRepository()
...
// Ports of Laravel tests/Config/RepositoryTest.php write behavior:
...
func TestLaravelRepositoryWriteBehavior(t *testing.T) {
	t.Parallel()
...
// Ports of Laravel tests/Config/RepositoryTest.php ArrayAccess behavior through
...
func TestLaravelRepositoryExplicitOffsetAdaptation(t *testing.T) {
	t.Parallel()
...
// Ports of Laravel tests/Config/RepositoryTest.php typed getter behavior:
...
func TestLaravelRepositoryTypedGetters(t *testing.T) {
	t.Parallel()
