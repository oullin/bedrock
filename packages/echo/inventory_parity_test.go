...
// packages/echo. Each `// Port of <path>::<test>` marker below maps an
...
//
// Grouped parity evidence: echo.client -> echo_test.go,
...
//
// Port of Echo.test.ts::it_will_not_throw_error_for_supported_driver.
// Port of Echo.test.ts::it_will_throw_error_for_unsupported_driver.
// Port of Echo.test.ts::it_can_get_connection_status.
