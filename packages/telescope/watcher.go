...
// forwards captured data to a Telescope instance via its Record* methods.
//
...
// SetTelescope attaches the Telescope instance to the watcher.
func (b *BaseWatcher) SetTelescope(t *Telescope) {
	b.telescope = t
}

// Scope returns the attached Telescope instance.
func (b *BaseWatcher) Scope() *Telescope {
	return b.telescope
}
