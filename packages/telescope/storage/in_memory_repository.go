// Package storage provides Telescope repository implementations.
package storage
...
type storedEntry struct {
	entry    *telescope.IncomingEntry
	sequence int64
}

// InMemoryRepository is a thread-safe, in-memory Telescope repository intended
...
var _ telescope.Repository = (*InMemoryRepository)(nil)
...
func (r *InMemoryRepository) toResult(se *storedEntry) *telescope.EntryResult {
	e := se.entry
