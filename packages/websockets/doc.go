...
// # Quick start
//
//	cfg := websockets.DefaultConfig()
//	cfg.Apps = []websockets.AppConfig{{
//	    ID: "app-1", Key: "key-1", Secret: "secret-1",
//	    AllowedOrigins: []string{"*"},
//	}}
//
//	apps := websockets.NewAppManager(cfg.Apps)
...
//
//	ws := websockets.NewServer(cfg, apps, conns, channels, dispatcher)
//	api := websockets.NewHTTPHandler(apps, channels, dispatcher)
//
