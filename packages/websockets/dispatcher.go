...
// coordination. Use this when all WebSockets server instances share the same
// process; for horizontal scaling across multiple processes use RedisDispatcher.
type SyncDispatcher struct {
	channels *ChannelManager
}

var _ contractsWebSockets.Dispatcher = (*SyncDispatcher)(nil)
...
// mirroring Upstream WebSockets's behaviour of silently ignoring missing channels.
//
