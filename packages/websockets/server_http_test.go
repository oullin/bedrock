...
func newHTTPTestSetup(t *testing.T) (*websockets.HTTPHandler, *websockets.AppManager, *websockets.ChannelManager) {
	t.Helper()
	...
	handler := websockets.NewHTTPHandler(apps, mgr, dispatcher)
