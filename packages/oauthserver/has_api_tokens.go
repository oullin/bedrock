...
// OAuthServer token authentication.
//
// In Upstream OAuthServer this is provided via the HasApiTokens trait. In Go,
...
// Mirrors Upstream's withAccessToken($token) which returns $this.
