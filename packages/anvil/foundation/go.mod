module github.com/bedrock/packages/anvil/foundation
...
replace github.com/bedrock/packages/anvil/console => ../console

replace github.com/bedrock/packages/anvil/http => ../http
