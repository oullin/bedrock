...
// Laravel: testWithBadKeyLengthAlternativeCipher
...
// Laravel: testWithUnsupportedCipher
...
// Laravel: testExceptionThrownWhenIvIsTooLong
...
// Laravel: testEncryptionUsingBase64EncodedKey
func TestEncryptionUsingBase64EncodedKey(t *testing.T) {
	rawKey := "abcdefghijklmnop"
	parsed, err := ParseLaravelKey("base64:" + base64.StdEncoding.EncodeToString([]byte(rawKey)))
	if err != nil {
...
// Laravel: testCipherNamesCanBeMixedCase
...
// Laravel: testDoNoAllowLongerKey
...
// Laravel: testThatAnAeadCipherIncludesTag
...
// Laravel: testThatANonAeadCipherIncludesMac
...
// Laravel: testEncryptedReturnsTrueForEncryptedArray
...
// Laravel: testEncryptedReturnsFalseForNonString (Go type safety test)
...
// Laravel: testExceptionThrownWithDifferentKey (explicit)
...
// Laravel: testRawStringEncryptionWithPreviousKeys (explicit)
...
// Laravel: testTamperedPayloadWillGetRejected (explicit)
...
// Laravel: testItValidatesMacOnPerKeyBasis
