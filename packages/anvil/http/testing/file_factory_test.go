...
// Upstream: testCreateWithMimeType
...
// Upstream: testCreateWithoutMimeType
...
// Upstream: testImageWebp — adapted to test unsupported format error
...
// Upstream: testImageBmp — adapted to test unsupported format error
