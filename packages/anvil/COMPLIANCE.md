...
**Laravel: 26 tests | Bedrock: 22 tests**
**Coverage: 85% (22/26)**
...
**Laravel: 92 + 10 = 102 tests | Bedrock: 53 tests**
**Coverage: 60% (61/102)**
...
**Laravel: 43 + 14 = 57 tests | Bedrock: 63 tests**
**Coverage: 70% (40/57)**
...
**Laravel: 9 + 10 = 19 tests | Bedrock: 24 tests**
**Coverage: 79% (15/19)**
...
**Laravel: 11 + 14 = 25 tests | Bedrock: 10 tests**
**Coverage: 28% (7/25)**
...
**Laravel: 102 tests (this file only, 11+ additional files) | Bedrock: 12 tests**
**Coverage: ~10%**
...
**Laravel: 113 tests (this file only, 9+ additional files) | Bedrock: 11 tests**
**Coverage: ~8%**
...
**Laravel: 42 tests (this file only, 15+ additional files) | Bedrock: 13 tests**
**Coverage: ~25%**
