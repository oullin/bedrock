...
// Laravel's ContainerCallTest covers Container::call() which invokes closures
// and methods with automatic dependency injection via reflection.
// Go has no reflection-based auto-wiring, so most Laravel tests are skipped.
