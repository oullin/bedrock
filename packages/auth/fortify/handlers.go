...
// Responder renders AuthFlows-style HTTP responses.
...
// Handler serves built-in AuthFlows-compatible HTTP handlers.
type Handler struct {
...
// RegisterRoutes attaches all AuthFlows-inspired routes to a mux.
