...
// Port of Illuminate\Tests\Auth\AuthDatabaseTokenRepositoryTest::testCreateInsertsNewRecordIntoTable
// Port of Illuminate\Tests\Auth\AuthDatabaseTokenRepositoryTest::testExistReturnsTrueIfValidRecordExists
// Port of Illuminate\Tests\Auth\AuthDatabaseTokenRepositoryTest::testExistReturnsFalseIfInvalidToken
func TestLaravelAuthDatabaseTokenRepositoryCreatesAndValidatesTokens(t *testing.T) {
...
// Port of Illuminate\Tests\Auth\AuthDatabaseTokenRepositoryTest::testExistReturnsFalseIfNoRowFoundForUser
// Port of Illuminate\Tests\Auth\AuthDatabaseTokenRepositoryTest::testExistReturnsFalseIfRecordIsExpired
func TestLaravelAuthDatabaseTokenRepositoryRejectsMissingAndExpiredTokens(t *testing.T) {
	ctx := context.Background()
...
// Port of Illuminate\Tests\Auth\AuthDatabaseTokenRepositoryTest::testRecentlyCreatedReturnsFalseIfNoRowFoundForUser
// Port of Illuminate\Tests\Auth\AuthDatabaseTokenRepositoryTest::testRecentlyCreatedReturnsTrueIfRecordIsRecentlyCreated
// Port of Illuminate\Tests\Auth\AuthDatabaseTokenRepositoryTest::testRecentlyCreatedReturnsFalseIfValidRecordExists
func TestLaravelAuthDatabaseTokenRepositoryRecentlyCreated(t *testing.T) {
	ctx := context.Background()
	repo := passwords.NewMemoryRepository(time.Hour)
...
// Port of Illuminate\Tests\Auth\AuthDatabaseTokenRepositoryTest::testDeleteMethodDeletesByToken
// Port of Illuminate\Tests\Auth\AuthDatabaseTokenRepositoryTest::testDeleteExpiredMethodDeletesExpiredTokens
func TestLaravelAuthDatabaseTokenRepositoryDeleteMethods(t *testing.T) {
	ctx := context.Background()
	repo := passwords.NewMemoryRepository(0)
...
// Port of Illuminate\Tests\Auth\AuthPasswordBrokerTest::testIfTokenIsRecentlyCreated
func TestLaravelAuthPasswordBrokerRejectsRecentlyCreatedToken(t *testing.T) {
	user := &resetUser{
...
// Port of Illuminate\Tests\Auth\AuthPasswordBrokerTest::testResetRemovesRecordOnReminderTableAndCallsCallback
func TestLaravelAuthPasswordBrokerResetDeletesTokenAndCallsCallback(t *testing.T) {
	user := &resetUser{
		GenericUser: auth.NewGenericUser(map[string]any{"id": "1"}),
		email:       "test@example.com",
	}
...
// Port of Illuminate\Tests\Auth\AuthPasswordBrokerTest::testRedirectIsReturnedByResetWhenUserCredentialsInvalid
func TestLaravelAuthPasswordBrokerResetRejectsInvalidToken(t *testing.T) {
	user := &resetUser{
		GenericUser: auth.NewGenericUser(map[string]any{"id": "1"}),
		email:       "test@example.com",
	}
