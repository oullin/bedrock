...
// ---------- Before allows, after skipped (GAP: Laravel runs after even on before short-circuit) ----------

// GAP: In Laravel, after callbacks run even when a before callback short-circuits.
...
func TestAfterSkippedWhenBeforeShortCircuits(t *testing.T) {
	...
	// NOTE: In Laravel, afterCalled would be true.
