...
func buildTestInception(guard *testGuard, provider *testProvider, events *testEvents, responder *testResponder) *Inception {
...
func TestLoginHandlerSuccess(t *testing.T) {
	...
	f := buildTestInception(guard, provider, events, responder)
...
func TestLoginHandlerJSONInput(t *testing.T) {
	...
	provider := &testProvider{user: user, validPassword: "secret"}
	responder := &testResponder{}
	f := buildTestInception(guard, provider, &testEvents{}, responder)
