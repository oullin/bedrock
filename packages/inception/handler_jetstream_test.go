...
func (g *jsTestGuard) Name() string { return "test" }
func (g *jsTestGuard) AuthenticateRequest(_ context.Context, _ http.ResponseWriter, _ *http.Request) (cauth.Authenticatable, error) {
	return g.user, nil
}
func (g *jsTestGuard) Login(_ context.Context, _ http.ResponseWriter, _ cauth.Authenticatable, _ bool) error {
	return nil
}
func (g *jsTestGuard) LoginWithPendingTwoFactor(_ context.Context, _ http.ResponseWriter, _ cauth.Authenticatable) error {
	return nil
}
func (g *jsTestGuard) Logout(_ context.Context, _ http.ResponseWriter, _ *http.Request) error {
	return nil
}
...
func (e *jsTestEvents) Listen(_ any, _ ...events.Listener)          {}
func (e *jsTestEvents) HasListeners(_ any) bool                     { return false }
func (e *jsTestEvents) HasWildcardListeners(_ any) bool             { return false }
func (e *jsTestEvents) Subscribe(_ events.Subscriber)               {}
func (e *jsTestEvents) Until(_ context.Context, _ any) (any, error) { return nil, nil }
func (e *jsTestEvents) Push(_ context.Context, _ any)               {}
func (e *jsTestEvents) Flush(_ context.Context, _ string) error     { return nil }
func (e *jsTestEvents) Forget(_ any)                                {}
func (e *jsTestEvents) ForgetPushed()                               {}
func (e *jsTestEvents) GetListeners(_ any) []events.Listener        { return nil }

func (e *jsTestEvents) Dispatch(_ context.Context, event any) ([]any, error) {
...
func buildTestInceptionJS(user *testTeamUser, teams *testTeamRepo, invitations *testInvitationRepo) (*Inception, *jsTestEvents) {
	ev := &jsTestEvents{}
...
func TestCreateTeamSuccess(t *testing.T) {
	...
	app, events := buildTestInceptionJS(user, teams, newTestInvitationRepo())

	handler := NewCreateTeamHandler(app)
...
func TestCreateTeamUnauthenticated(t *testing.T) {
	app, _ := buildTestInceptionJS(nil, newTestTeamRepo(), newTestInvitationRepo())
	app.guard = &jsTestGuard{user: nil}
...
func TestUpdateTeamSuccess(t *testing.T) {
	...
	mux.Handle("PUT /teams/{team}", NewUpdateTeamHandler(app))
...
func TestUpdateTeamForbiddenForNonOwner(t *testing.T) {
	...
	teams := newTestTeamRepo(team)
	app, _ := buildTestInceptionJS(user, teams, newTestInvitationRepo())
...
func TestDeleteTeamSuccess(t *testing.T) {
	...
	mux := http.NewServeMux()
	mux.Handle("DELETE /teams/{team}", NewDeleteTeamHandler(app))
...
func TestAddTeamMemberSuccess(t *testing.T) {
	...
	mux := http.NewServeMux()
	mux.Handle("POST /teams/{team}/members", NewAddTeamMemberHandler(app))
...
func TestUpdateMemberRoleSuccess(t *testing.T) {
	...
	mux := http.NewServeMux()
	mux.Handle("PUT /teams/{team}/members/{user}", NewUpdateTeamMemberRoleHandler(app))
...
func TestRemoveTeamMemberSuccess(t *testing.T) {
	...
	mux := http.NewServeMux()
	mux.Handle("DELETE /teams/{team}/members/{user}", NewRemoveTeamMemberHandler(app))
...
func TestInviteTeamMemberSuccess(t *testing.T) {
	...
	mux := http.NewServeMux()
	mux.Handle("POST /teams/{team}/invitations", NewInviteTeamMemberHandler(app))
...
func TestCancelInvitationSuccess(t *testing.T) {
	...
	app, _ := buildTestInceptionJS(user, teams, invitations)

	mux := http.NewServeMux()
	mux.Handle("DELETE /team-invitations/{invitation}", NewCancelInvitationHandler(app))
...
func TestAcceptInvitationSuccess(t *testing.T) {
	...
	teams := newTestTeamRepo(team)
	invitations := newTestInvitationRepo(invitation)
	app, events := buildTestInceptionJS(user, teams, invitations)

	mux := http.NewServeMux()
	mux.Handle("GET /team-invitations/{invitation}/accept", NewAcceptInvitationHandler(app))
...
func TestSwitchTeamSuccess(t *testing.T) {
	...
	handler := NewSwitchTeamHandler(app)
	w := httptest.NewRecorder()
