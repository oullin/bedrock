...
[![Go Report Card](https://goreportcard.com/badge/github.com/bedrock/packages/money)](https://goreportcard.com/report/github.com/bedrock/packages/money)
[![Go Reference](https://pkg.go.dev/badge/github.com/bedrock/packages/money.svg)](https://pkg.go.dev/github.com/bedrock/packages/money)
...
```bash
go get github.com/bedrock/packages/money
```
...
- `github.com/bedrock/packages/money/money`: `Money`, `Manager`, `Aggregator`, `Converter`
- `github.com/bedrock/packages/money/currency`: ISO currency data + `Manager`
- `github.com/bedrock/packages/money/exchange`: in-memory exchange rates + conversion
- `github.com/bedrock/packages/money/parser`: parse strings like `$1,234.56`, `EUR 10,50`
- `github.com/bedrock/packages/money/format`: currency formatter used by `currency.Currency`
- `github.com/bedrock/packages/money/exception`: sentinel errors used across the module
...
import (
	...
	"github.com/bedrock/packages/money/money"
)
...
import (
	"github.com/bedrock/packages/money/currency"
	"github.com/bedrock/packages/money/exchange"
	"github.com/bedrock/packages/money/money"
)
...
Common sentinel errors live in `github.com/bedrock/packages/money/exception` (e.g. `exception.ErrCurrencyMismatch`).
