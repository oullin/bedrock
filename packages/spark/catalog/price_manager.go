...
func NewPlanPeriodPriceManager(prices spark.PriceStore, txn spark.TransactionManager) *PlanPeriodPriceManager {
...
func (m *PlanPeriodPriceManager) RotatePrice(ctx context.Context, planPeriodID int64, newPrice spark.PlanPeriodPrice) error {
