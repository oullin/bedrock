...
// newly-created billable, including Spark's generic trial window.
...
// SparkPlan returns the plan matching the current valid subscription.
func SparkPlan(manager *Manager, billable Billable, subscription *Subscription) *Plan {
...
// CanUpdateSeats reports whether Spark allows the billable to mutate seat
// quantity.
