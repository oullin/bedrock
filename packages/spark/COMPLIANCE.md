...
|--------|----------|-----------|
| laravel/cashier-paddle | `vendor/laravel/cashier-paddle/src/` | 32 |
| laravel/spark-paddle | `vendor/laravel/spark-paddle/src/` | 24 |
...
| SparkServiceProvider.php | *Not ported* | — |
...
| PHP File | Go File | Tested |
|----------|---------|--------|
| Actions/GenerateSparkCheckoutSession.php | interfaces.go (ProviderCheckoutGenerator) | No |
| BillingConstants.php | billing.go | No |
| Catalog/PlanCatalog.php | catalog.go | No |
| Catalog/SparkPlanRegistry.php | catalog_presentation.go | No |
...
These PHP files have no Go equivalent because they are Laravel/PHP framework plumbing with no meaningful Go counterpart:
