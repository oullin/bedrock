...
type FrontendStateBuilder struct {
	...
	pricePreviewer spark.ProviderPricePreviewer
	clock          spark.Clock
}
...
func (f *FrontendStateBuilder) Current(ctx context.Context, billableType string, billable spark.Billable) (*FrontendStateView, error) {
...
func (f *FrontendStateBuilder) resolveState(ctx context.Context, billable spark.Billable, sub *spark.Subscription) string {
	if sub == nil {
