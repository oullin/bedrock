...
func (s *testSubStore) FindByID(_ context.Context, _ int64) (*spark.Subscription, error) {
	return nil, nil
}
func (s *testSubStore) FindByProviderID(_ context.Context, _ string) (*spark.Subscription, error) {
	return nil, nil
}
func (s *testSubStore) CurrentForBillable(_ context.Context, _ string, _ int64) (*spark.Subscription, error) {
	return nil, nil
}
func (s *testSubStore) ActiveForBillable(_ context.Context, _ string, _ int64) ([]*spark.Subscription, error) {
	return s.subs, nil
}
func (s *testSubStore) Create(_ context.Context, _ *spark.Subscription) error { return nil }
func (s *testSubStore) Save(_ context.Context, _ *spark.Subscription) error   { return nil }
func (s *testSubStore) Delete(_ context.Context, _ int64) error               { return nil }

func (s *testOrderStore) FindByID(_ context.Context, _ int64) (*spark.Order, error) { return nil, nil }
func (s *testOrderStore) FindByBillable(_ context.Context, _ int64, _ int) ([]spark.Order, error) {
	return nil, nil
}
func (s *testOrderStore) Create(_ context.Context, _ *spark.Order) error { return nil }
func (s *testOrderStore) Save(_ context.Context, _ *spark.Order) error   { return nil }
func (s *testOrderStore) HasCompletedForProduct(_ context.Context, _ int64, _ int64) (bool, error) {
	return false, nil
}

func (s *testProductStore) FindByID(_ context.Context, _ int64) (*spark.Product, error) {
	return nil, nil
}
func (s *testProductStore) Active(_ context.Context) ([]spark.Product, error) {
	return append(s.subProducts, s.oneTimeProducts...), nil
}
func (s *testProductStore) ActiveSubscriptions(_ context.Context) ([]spark.Product, error) {
	return s.subProducts, nil
}
func (s *testProductStore) ActiveOneTime(_ context.Context) ([]spark.Product, error) {
	return s.oneTimeProducts, nil
}

// --- helper ---

func newGateway(resolver spark.ResolverFunc, products *testProductStore) *handler.GatewayHandler {
...
func TestGatewayHandler_Show_IncludesProducts(t *testing.T) {
	...
	products := &testProductStore{
		subProducts: []spark.Product{
			{ID: 1, Name: "Pro Plan", Type: spark.ProductTypeSubscription, Active: true},
		},
		oneTimeProducts: []spark.Product{
			{ID: 2, Name: "Theme Pack", Type: spark.ProductTypeOneTime, Active: true},
		},
	}
