...
var (
	...
	ErrNotSubscribed          = errors.New("spark: billable is not subscribed")
	ErrPlanNotEligible        = errors.New("spark: billable is not eligible for this plan")
	ErrSubscriptionNotOnGrace = errors.New("spark: subscription is not on a grace period")
	ErrSubscriptionTerminal   = errors.New("spark: subscription is in a terminal state")
	ErrNoActivePrice          = errors.New("spark: no active price available for the plan period")
	ErrPendingCheckoutExists  = errors.New("spark: a pending checkout already exists")
	ErrRecoveryFailed         = errors.New("spark: explicit subscription recovery failed")
	ErrUnauthorized           = errors.New("spark: not authorized to view billing portal")
...
func (e ValidationErrors) Error() string {
	if len(e) == 0 {
		return "spark: validation failed"
	}
