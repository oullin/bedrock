...
func NewPlanPeriodPriceManager(prices PriceStore, txn TransactionManager) *PlanPeriodPriceManager {
...
func (m *PlanPeriodPriceManager) RotatePrice(ctx context.Context, planPeriodID int64, newPrice PlanPeriodPrice) error {
