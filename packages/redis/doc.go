...
// Sentinel variants, and Upstream-compatible ConcurrencyLimiter and
// DurationLimiter.
//
// The package targets 100% functional parity with Upstream 13.x
// Framework\Redis and 1:1 test-case parity with its suite at
// upstream/framework tests/Redis/ and tests/Integration/Redis/.
//
