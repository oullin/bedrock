...
// before it attempts to pop a job. Mirrors Framework\Queue\Events\Looping.
type Looping struct {
...
// Mirrors Framework\Queue\Events\QueueBusy.
...
// queue:pause command. Mirrors Framework\Queue\Events\QueuePaused.
//
// Upstream's event carries an integer `ttl` (seconds, null for indefinite).
...
// the queue:resume command. Mirrors Framework\Queue\Events\QueueResumed.
...
// Framework\Queue\Events\QueueFailedOver.
