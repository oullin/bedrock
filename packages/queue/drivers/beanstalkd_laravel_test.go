...
// Ports of Framework\Tests\Queue\QueueBeanstalkdQueueTest.
//
// Upstream's tests use Mockery on a Pheanstalk transport; they assert
...
//
//   - Upstream's BeanstalkdQueue fuses useTube()+put() as two wire calls.
...
//   - Upstream's test pins the payload body byte-for-byte via Str::uuid
...
// Port of Framework\Tests\Queue\QueueBeanstalkdQueueTest::testPushProperlyPushesJobOntoBeanstalkd
...
// Port of Framework\Tests\Queue\QueueBeanstalkdQueueTest::testDelayedPushProperlyPushesJobOntoBeanstalkd
func TestDelayedPushProperlyPushesJobOntoBeanstalkd(t *testing.T) {
	...
	for i, p := range client.puts {
		...
		// Upstream's Pheanstalk::DEFAULT_TTR constant.
		if p.ttr != 60*time.Second {
			t.Errorf("puts[%d].ttr: got %s, want 60s", i, p.ttr)
		}
	}
...
// Port of Framework\Tests\Queue\QueueBeanstalkdQueueTest::testPopProperlyPopsJobOffOfBeanstalkd
...
// Port of Framework\Tests\Queue\QueueBeanstalkdQueueTest::testBlockingPopProperlyPopsJobOffOfBeanstalkd
...
// Port of Framework\Tests\Queue\QueueBeanstalkdQueueTest::testDeleteProperlyRemoveJobsOffBeanstalkd
...
// Port of Framework\Tests\Queue\QueueBeanstalkdJobTest::testFireProperlyCallsTheJobHandler
...
// Port of Framework\Tests\Queue\QueueBeanstalkdJobTest::testFailProperlyCallsTheJobHandler
...
// Port of Framework\Tests\Queue\QueueBeanstalkdJobTest::testDeleteRemovesTheJobFromBeanstalkd
...
// Port of Framework\Tests\Queue\QueueBeanstalkdJobTest::testReleaseProperlyReleasesJobOntoBeanstalkd
...
// Port of Framework\Tests\Queue\QueueBeanstalkdJobTest::testBuryProperlyBuryTheJobFromBeanstalkd
