...
// Port of Illuminate\Tests\Queue\FailoverQueueTest.
//
// Laravel's FailoverQueue takes a QueueManager, an events Dispatcher,
...
// Port of Illuminate\Tests\Queue\FailoverQueueTest::test_push_fails_over_on_exception
