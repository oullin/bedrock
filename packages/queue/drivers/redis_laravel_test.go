...
// Ports of Illuminate\Tests\Queue\QueueRedisQueueTest.
//
// Laravel's tests assert the exact Lua script + wire command sent to
...
//
//   - Laravel's `Str::createUuidsUsing` / `Carbon::setTestNow` shims have
//     no Go equivalent. Tests assert shape (keys, queue wrapping, delay
//     arithmetic) rather than raw UUID / timestamp bytes.
//   - `testPush*` Laravel tests pin the raw Lua-script body byte-for-byte.
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testGetQueueRemainsUnchangedForNonCluster
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testGetQueueRemainsUnchangedForCluster
//
// Laravel's getQueue() MUST pass through unchanged on a cluster
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testGetRedisKeyReturnsPlainKeyForNonCluster
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testPushProperlyPushesJobOntoRedisWithTwoCustomPayloadHook
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testPushUsesGetRedisKeyForLuaScript
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testPushPassesUnchangedQueueToCreatePayload
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testSizeUsesGetRedisKeyOnCluster
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testClearUsesGetRedisKeyOnCluster
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testGetRedisKeyWrapsWithHashTagsForPhpRedisCluster
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testGetRedisKeyWrapsWithHashTagsForPredisCluster
//
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testGetRedisKeyDoesNotDoubleWrapExistingHashTags
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testGetRedisKeySkipsWrappingWhenQueueNameContainsBraces
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testGetRedisKeyWrapsEmptyHashTagOnCluster
//
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testGetRedisKeyWrapsUnmatchedOpeningBrace
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testGetRedisKeyWrapsUnmatchedClosingBrace
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testGetRedisKeyWrapsEmptyFirstHashTagFollowedByValidPair
//
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testPushProperlyPushesJobOntoRedis
//
// Adaptation: Laravel asserts the exact Lua-script payload byte-for-byte
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testDelayedPushProperlyPushesJobOntoRedis
//
// Adaptation: Laravel asserts that EVAL is invoked with LuaScripts::later,
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testDelayedPushWithDateTimeProperlyPushesJobOntoRedis
//
// Adaptation: `later($dateTime, ...)` in Laravel passes a Carbon instance
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testPushProperlyPushesJobOntoRedisWithCustomPayloadHook
//
// Adaptation: Laravel's `Queue::createPayloadUsing` hook is a package-level
...
func TestRedisPushProperlyPushesJobOntoRedisWithCustomPayloadHook(t *testing.T) {
	...
	// Laravel's Queue::createPayloadUsing hook injecting extra data.
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testIsClusterConnectionCachesResult
//
// Laravel uses the `??=` null-coalescing assignment to cache the cluster
...
// Implicit port of Illuminate\Tests\Queue\QueueRedisQueueTest::testIsClusterConnection
...
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest — extra coverage for
...
//
// Port of Illuminate\Tests\Queue\QueueRedisQueueTest::testGetQueueRedisKey
