...
// Partial port of Illuminate\Tests\Queue\QueueDatabaseQueueUnitTest.
//
...
//
//   - Laravel's DatabaseQueue uses a fluent query builder
...
//   - Laravel freezes time with Carbon::setTestNow and locks the UUID
...
// the INSERT carries the Laravel-shape uuid/displayName/job fields.

// DatabaseLaravelTestJob is a Go analogue of the PHP `MyTestJob`
// fixture used by the Laravel data provider. The suffix of its
// reflect-derived display name (`.DatabaseLaravelTestJob`) is what
// the port asserts on.
type DatabaseLaravelTestJob struct{}
...
// Port of Illuminate\Tests\Queue\QueueDatabaseQueueUnitTest::testBuildDatabaseRecordWithPayloadAtTheEnd
...
// Port of Illuminate\Tests\Queue\QueueDatabaseQueueUnitTest::testGetLockForPoppingIsCached
...
// Port of Illuminate\Tests\Queue\QueueDatabaseQueueUnitTest::testPushProperlyPushesJobOntoDatabase
//
// Laravel's test uses a PHP data provider to drive three variants
...
func TestPushProperlyPushesJobOntoDatabase(t *testing.T) {
	...
	cases := []struct {
		...
		{"struct", DatabaseLaravelTestJob{}, ".DatabaseLaravelTestJob"},
		{"string", "foo", "foo"},
	}
...
// Port of Illuminate\Tests\Queue\QueueDatabaseQueueUnitTest::testDelayedPushProperlyPushesJobOntoDatabase
func TestDelayedPushProperlyPushesJobOntoDatabase(t *testing.T) {
	...
	// Laravel asserts availableAt is an int and reflects the 10-second
...
// Port of Illuminate\Tests\Queue\QueueDatabaseQueueUnitTest::testFailureToCreatePayloadFromArray
//
// Laravel feeds createPayload a value containing invalid UTF-8 and
...
// Port of Illuminate\Tests\Queue\QueueDatabaseQueueUnitTest::testFailureToCreatePayloadFromObject
//
