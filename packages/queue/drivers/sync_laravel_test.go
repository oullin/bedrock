...
// Ports of Illuminate\Tests\Queue\QueueSyncQueueTest (partial: 4 of 8).
//
...
// observable Laravel behaviours that land in Step 7:
//
...
// Port of Illuminate\Tests\Queue\QueueSyncQueueTest::testPushShouldFireJobInstantly
...
// Port of Illuminate\Tests\Queue\QueueSyncQueueTest::testFailedJobGetsHandledWhenAnExceptionIsThrown
func TestFailedJobGetsHandledWhenAnExceptionIsThrown(t *testing.T) {
	...
	// Laravel dispatches exactly 4 events on the failure path:
...
// Port of Illuminate\Tests\Queue\QueueSyncQueueTest::testFailedJobHasAccessToJobInstance
//
...
// Port of Illuminate\Tests\Queue\QueueSyncQueueTest::testCreatesPayloadObject
//
// Not t.Parallel: mutates the global payload-hook list.
