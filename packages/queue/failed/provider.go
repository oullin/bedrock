...
// Go analogue of the stdClass rows Upstream's providers yield: the public
...
// Framework\Queue\Failed\FailedJobProviderInterface. It abstracts the
...
//   - Find returns (nil, nil) when the id does not exist (Upstream
//     returns null).
