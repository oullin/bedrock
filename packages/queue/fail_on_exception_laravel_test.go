...
// Port of Framework\Tests\Queue\FailOnExceptionMiddlewareTest::test_middleware
...
// Port of Framework\Tests\Queue\FailOnExceptionMiddlewareTest::test_can_test_against_job_properties
func TestFailOnExceptionMiddlewareCanInspectJobProperties(t *testing.T) {
	t.Parallel()

	job := &workerUpstreamJob{queueName: "critical"}
