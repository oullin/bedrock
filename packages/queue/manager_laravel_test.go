...
// Ports of Illuminate\Tests\Queue\QueueManagerTest.
//
// Laravel's test uses Mockery on stdClass to assert that the Manager:
...
// Port of Illuminate\Tests\Queue\QueueManagerTest::testDefaultConnectionCanBeResolved
...
// Port of Illuminate\Tests\Queue\QueueManagerTest::testOtherConnectionCanBeResolved
func TestOtherConnectionCanBeResolved(t *testing.T) {
	...
	// Laravel stamps the CONNECTION name (foo) not the driver name (bar).
	if fakeQueue.ConnectionName() != "foo" {
		t.Errorf("setConnectionName: got %q, want foo", fakeQueue.ConnectionName())
	}
}

// Port of Illuminate\Tests\Queue\QueueManagerTest::testNullConnectionCanBeResolved
func TestNullConnectionCanBeResolved(t *testing.T) {
	...
	// Laravel synthesises ['driver' => 'null'] when no explicit config exists.
...
// Port of Illuminate\Tests\Queue\QueueManagerTest::testEnumConnectionCanBeResolved
...
// Port of Illuminate\Tests\Queue\QueueManagerTest::testEnumConnectionCanBeChecked
