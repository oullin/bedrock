...
import contractsReverb "github.com/bedrock/packages/contracts/reverb"

// App holds the runtime configuration for a single Reverb application.
// It implements contracts/reverb.App.
type App struct {
	id              string
	key             string
	secret          string
...
var _ contractsReverb.App = (*App)(nil)
