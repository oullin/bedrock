...
func TestResponseRedirectAndViewAssertions(t *testing.T) {
	...
	t.Run("TestResponseTest::testAssertViewHasOrmCollection", func(t *testing.T) {
		rec := newRecorder()
	...
	t.Run("TestResponseTest::testAssertViewHasOrmCollectionRespectsOrder", func(t *testing.T) {
		rec := newRecorder()
	...
	t.Run("TestResponseTest::testAssertViewHasOrmCollectionRespectsType", func(t *testing.T) {
		rec := newRecorder()
	...
	t.Run("TestResponseTest::testAssertViewHasOrmCollectionRespectsSize", func(t *testing.T) {
		rec := newRecorder()
