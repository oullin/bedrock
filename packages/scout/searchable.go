...
// GetScoutKey returns the scout key for the model. By default, this is
// the model's primary key value.
func GetScoutKey(model contract.Searchable) any {
	return model.GetKey()
}

// GetScoutKeyName returns the scout key name for the model. By default,
