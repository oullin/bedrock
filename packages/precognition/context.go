...
// This is the Go equivalent of Laravel's
...
// precognitive via [MarkPrecognitive]. This is the Go equivalent of Laravel's
...
// to make a precognitive request, matching Laravel's
// $request->isAttemptingPrecognition() which checks the header exactly.
