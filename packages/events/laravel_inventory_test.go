...
func TestUpstreamEventsDispatcherInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamEventsSubscriberInventoryEquivalents(t *testing.T) {
	t.Parallel()
...
func TestUpstreamQueuedEventsInventoryEquivalents(t *testing.T) {
	t.Parallel()
