...
func NewCreateTokenHandler(js *AuthKit, tokens TokenRepository) *CreateTokenHandler {
...
func NewUpdateTokenHandler(js *AuthKit, tokens TokenRepository) *UpdateTokenHandler {
...
func NewDeleteTokenHandler(js *AuthKit, tokens TokenRepository) *DeleteTokenHandler {
