...
func NewListSessionsHandler(js *AuthKit, sessions SessionRepository) *ListSessionsHandler {
...
func NewDeleteOtherSessionsHandler(js *AuthKit, sessions SessionRepository) *DeleteOtherSessionsHandler {
