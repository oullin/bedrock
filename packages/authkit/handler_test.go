...
type testGuard struct {
	user authflows.Authenticatable
}
...
func (g *testGuard) AuthenticateRequest(_ context.Context, _ http.ResponseWriter, _ *http.Request) (authflows.Authenticatable, error) {
	return g.user, nil
}
func (g *testGuard) Login(_ context.Context, _ http.ResponseWriter, _ authflows.Authenticatable, _ bool) error {
	return nil
}
func (g *testGuard) LoginWithPendingTwoFactor(_ context.Context, _ http.ResponseWriter, _ authflows.Authenticatable) error {
	return nil
}
