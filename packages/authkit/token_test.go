...
func TestCreateTokenSuccess(t *testing.T) {
	...
	js, events := buildTestAuthKit(user, newTestTeamRepo(), newTestInvitationRepo())
...
func (p *stubUserProvider) RetrieveByCredentials(_ context.Context, _ map[string]string) (authflows.Authenticatable, error) {
	return nil, nil
}
func (p *stubUserProvider) UpdateRememberToken(_ context.Context, _ authflows.Authenticatable, _ string) error {
	return nil
}
func (p *stubUserProvider) ValidateCredentials(_ context.Context, _ authflows.Authenticatable, _ map[string]string) (bool, error) {
	return false, nil
}
func (p *stubUserProvider) RehashPasswordIfRequired(_ context.Context, _ authflows.Authenticatable, _ map[string]string, _ bool) error {
	return nil
}
