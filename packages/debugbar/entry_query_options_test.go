...
func TestDefaultQueryOptionsHasLimit50(t *testing.T) {
	...
	opts := debugbar.DefaultQueryOptions()
...
func TestEntryQueryOptionsForBatchID(t *testing.T) {
	...
	opts := debugbar.DefaultQueryOptions().ForBatchID("batch-xyz")
	...
	original := debugbar.DefaultQueryOptions()
...
func TestEntryQueryOptionsWithTag(t *testing.T) {
	...
	opts := debugbar.DefaultQueryOptions().WithTag("billing")
...
func TestEntryQueryOptionsWithLimit(t *testing.T) {
	...
	opts := debugbar.DefaultQueryOptions().WithLimit(100)
...
func TestEntryQueryOptionsWithFamilyHash(t *testing.T) {
	...
	opts := debugbar.DefaultQueryOptions().WithFamilyHash("abc123")
...
func TestEntryQueryOptionsBefore(t *testing.T) {
	...
	opts := debugbar.DefaultQueryOptions().Before(999)
...
func TestEntryQueryOptionsImmutable(t *testing.T) {
	...
	base := debugbar.DefaultQueryOptions()
