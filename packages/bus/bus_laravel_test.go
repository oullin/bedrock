...
// Port of Illuminate\Tests\Bus\BusBatchTest::test_jobs_can_be_added_to_the_batch
func TestLaravelBusBatchAddAssignsBatchIDAndDispatches(t *testing.T) {
...
// Port of Illuminate\Tests\Bus\BusBatchTest::test_processed_jobs_can_be_calculated
func TestLaravelBusBatchProcessedJobsAndProgress(t *testing.T) {
...
// Port of Illuminate\Tests\Bus\BusBatchTest::test_successful_jobs_can_be_recorded
// Port of Illuminate\Tests\Bus\BusBatchTest::test_batch_finished_event_is_dispatched
// Port of Illuminate\Tests\Bus\BusBatchTest::test_batch_started_event_is_dispatched
func TestLaravelBusBatchSuccessfulJobsLifecycle(t *testing.T) {
...
// Port of Illuminate\Tests\Bus\BusBatchTest::test_batch_started_event_is_dispatched_when_first_job_fails
// Port of Illuminate\Tests\Bus\BusBatchTest::test_failed_jobs_can_be_recorded_while_not_allowing_failures
// Port of Illuminate\Tests\Bus\BusBatchTest::test_failed_jobs_can_be_recorded_while_allowing_failures
// Port of Illuminate\Tests\Bus\BusBatchTest::test_failure_callbacks_execute_correctly
func TestLaravelBusBatchFailedJobsLifecycle(t *testing.T) {
...
// Port of Illuminate\Tests\Bus\BusBatchTest::test_batch_can_be_cancelled
// Port of Illuminate\Tests\Bus\BusBatchTest::test_batch_cancelled_event_is_dispatched
// Port of Illuminate\Tests\Bus\BusBatchTest::test_batch_can_be_deleted
// Port of Illuminate\Tests\Bus\BusBatchTest::test_batch_state_can_be_inspected
func TestLaravelBusBatchStateAndDeletion(t *testing.T) {
...
// Port of Illuminate\Tests\Bus\BusBatchTest::test_chain_can_be_added_to_batch
// Port of Illuminate\Tests\Bus\BusBatchTest::test_chained_jobs_in_batch_preserve_their_queue_when_batch_has_no_queue
func TestLaravelBusBatchAddChainJobs(t *testing.T) {
	d := newMockQueueingDispatcher()
...
// Port of Illuminate\Tests\Bus\BusBatchableTest::test_batch_may_be_retrieved
// Port of Illuminate\Tests\Bus\BusBatchableTest::test_with_fake_batch_sets_and_returns_fake
// Port of Illuminate\Tests\Bus\BusBatchableTest::test_batching_reflects_cancelled_state
func TestLaravelBusBatchableHelpers(t *testing.T) {
	repo := newMockBatchRepo()
...
// Port of Illuminate\Tests\Bus\BusDispatcherTest::testCommandsThatShouldQueueIsQueued
// Port of Illuminate\Tests\Bus\BusDispatcherTest::testCommandsThatShouldQueueIsQueuedUsingCustomHandler
// Port of Illuminate\Tests\Bus\BusDispatcherTest::testCommandsThatShouldQueueIsQueuedUsingCustomQueueAndDelay
// Port of Illuminate\Tests\Bus\BusDispatcherTest::testCommandsAreDispatchedWithQueueRoute
// Port of Illuminate\Tests\Bus\BusDispatcherTest::testDispatchNowShouldNeverQueue
// Port of Illuminate\Tests\Bus\BusDispatcherTest::testDispatcherCanDispatchStandAloneHandler
// Port of Illuminate\Tests\Bus\BusDispatcherTest::testOnConnectionOnJobWhenDispatching
func TestLaravelBusDispatcherQueueRoutingAndSync(t *testing.T) {
	q := newMockQueue()
...
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_pending_batch_may_be_configured_and_dispatched
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_batch_is_deleted_from_storage_if_exception_thrown_during_batching
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_batch_is_dispatched_when_dispatchif_is_true
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_batch_is_not_dispatched_when_dispatchif_is_false
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_batch_is_dispatched_when_dispatchunless_is_false
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_batch_is_not_dispatched_when_dispatchunless_is_true
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_batch_before_event_is_called
func TestLaravelBusPendingBatchDispatchControls(t *testing.T) {
	d := newMockQueueingDispatcher()
...
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_allow_failures_with_boolean_true_enables_failure_tolerance
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_allow_failures_with_boolean_false_disables_failure_tolerance
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_allow_failures_with_single_closure_registers_callback
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_allow_failures_with_array_of_callables_registers_multiple_callbacks
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_allow_failures_with_empty_array_enables_tolerance_without_callbacks
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_allow_failures_is_chainable
// Port of Illuminate\Tests\Bus\BusPendingBatchTest::test_failure_callbacks_accessor_returns_registered_callbacks
func TestLaravelBusPendingBatchAllowFailuresTypedAPI(t *testing.T) {
	d := newMockQueueingDispatcher()
	pending := bus.NewPendingBatch(d, []any{&laravelBatchJob{Name: "one"}})
...
// Port of Illuminate\Tests\Bus\BusPendingDispatchTest::testOnConnection
// Port of Illuminate\Tests\Bus\BusPendingDispatchTest::testOnQueue
// Port of Illuminate\Tests\Bus\BusPendingDispatchTest::testAllOnConnection
// Port of Illuminate\Tests\Bus\BusPendingDispatchTest::testAllOnQueue
// Port of Illuminate\Tests\Bus\BusPendingDispatchTest::testDelay
// Port of Illuminate\Tests\Bus\BusPendingDispatchTest::testWithoutDelay
// Port of Illuminate\Tests\Bus\BusPendingDispatchTest::testAfterCommit
// Port of Illuminate\Tests\Bus\BusPendingDispatchTest::testBeforeCommit
// Port of Illuminate\Tests\Bus\BusPendingDispatchTest::testChain
// Port of Illuminate\Tests\Bus\BusPendingDispatchTest::testAfterResponse
// Port of Illuminate\Tests\Bus\BusPendingDispatchTest::testGetJob
// Port of Illuminate\Tests\Bus\QueueableTest::testOnConnection
// Port of Illuminate\Tests\Bus\QueueableTest::testAllOnConnection
// Port of Illuminate\Tests\Bus\QueueableTest::testOnQueue
// Port of Illuminate\Tests\Bus\QueueableTest::testAllOnQueue
func TestLaravelBusQueueableAndPendingDispatchEquivalentFluentAPI(t *testing.T) {
	first := &laravelBatchJob{Name: "first"}
	second := &laravelBatchJob{Name: "second"}
