...
// packages/broadcastclient. Each `// Port of <Class>::<test>` marker below maps an
...
// read by services/scripts/upstream-compliance.sh via rg.
...
//
// Port of BroadcastClient::it_will_not_throw_error_for_supported_driver.
// Port of BroadcastClient::it_will_throw_error_for_unsupported_driver.
// Port of BroadcastClient::it_can_get_connection_status.
