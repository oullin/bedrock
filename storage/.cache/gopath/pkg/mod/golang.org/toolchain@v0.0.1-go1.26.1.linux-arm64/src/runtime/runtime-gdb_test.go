...
func testGdbPython(t *testing.T, cgo bool) {
	...
	args = append(args,
		...
		"-ex", "run",
		"-ex", "broadcastclient BEGIN info goroutines\n",
		"-ex", "info goroutines",
		"-ex", "broadcastclient END\n",
		"-ex", "broadcastclient BEGIN print smallmapvar\n",
		"-ex", "print smallmapvar",
		"-ex", "broadcastclient END\n",
		"-ex", "broadcastclient BEGIN print mapvar\n",
		"-ex", "print mapvar",
		"-ex", "broadcastclient END\n",
		"-ex", "broadcastclient BEGIN print slicemap\n",
		"-ex", "print slicemap",
		"-ex", "broadcastclient END\n",
		"-ex", "broadcastclient BEGIN print strvar\n",
		"-ex", "print strvar",
		"-ex", "broadcastclient END\n",
		"-ex", "broadcastclient BEGIN print chanint\n",
		"-ex", "print chanint",
		"-ex", "broadcastclient END\n",
		"-ex", "broadcastclient BEGIN print chanstr\n",
		"-ex", "print chanstr",
		"-ex", "broadcastclient END\n",
		"-ex", "broadcastclient BEGIN info locals\n",
		"-ex", "info locals",
		"-ex", "broadcastclient END\n",
		"-ex", "broadcastclient BEGIN goroutine 1 bt\n",
		"-ex", "goroutine 1 bt",
		"-ex", "broadcastclient END\n",
		"-ex", "broadcastclient BEGIN goroutine all bt\n",
		"-ex", "goroutine all bt",
		"-ex", "broadcastclient END\n",
		"-ex", "clear main.go:15", // clear the previous break point
		"-ex", fmt.Sprintf("br main.go:%d", nLines), // new break point at the end of main
		"-ex", "c",
		"-ex", "broadcastclient BEGIN goroutine 1 bt at the end\n",
		"-ex", "goroutine 1 bt",
		"-ex", "broadcastclient END\n",
