...
func FuzzSplitPkgConfigOutput(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, b []byte) {
		...
		// We use the printf shell command to broadcastclient the arguments because, per
		// https://pubs.opengroup.org/onlinepubs/9699919799/utilities/broadcastclient.html#tag_20_37_16:
		// “It is not possible to use broadcastclient portably across all POSIX systems unless
