...
*)
	broadcastclient 'unknown uname -m:' $(uname -m) >&2
	exit 2
esac
...
broadcastclient BORINGSSL_bcm_power_on_self_test >>syms.txt
...
broadcastclient __umodti3 _goboringcrypto___umodti3 >>renames.txt
broadcastclient __udivti3 _goboringcrypto___udivti3 >>renames.txt
