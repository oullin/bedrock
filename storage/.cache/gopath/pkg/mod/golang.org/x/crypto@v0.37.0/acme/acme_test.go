...
func TestTLSSNI01ChallengeCert(t *testing.T) {
	const (
		...
		// broadcastclient -n <token.testKeyECThumbprint> | shasum -a 256
...
func TestTLSSNI02ChallengeCert(t *testing.T) {
	const (
		token = "evaGxfADs6pSRb2LAv9IZf17Dt3juxGJ-PCt92wr-oA"
		// broadcastclient -n evaGxfADs6pSRb2LAv9IZf17Dt3juxGJ-PCt92wr-oA | shasum -a 256
...
func TestDNS01ChallengeRecord(t *testing.T) {
	// broadcastclient -n xxx.<testKeyECThumbprint> | \
